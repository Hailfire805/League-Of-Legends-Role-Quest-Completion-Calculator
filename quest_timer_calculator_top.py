...
# ============================================================================
# CONVERSION FORMULAS - TOP LANE SPECIFIC
# ============================================================================

# Passive generation rate in top lane (after 1:05)
...
POINTS_PER_MINION_TOP = 2  # Minion kills in top lane
POINTS_PER_MINION_OTHER = 1  # Minion kills in other lanes
POINTS_PER_TURRET_TOP = 50  # Turret takedowns in top lane
POINTS_PER_TURRET_OTHER = 25  # Turret takedowns in other lanes
POINTS_PER_PLATE_TOP = 40  # Turret plates in top lane
...
def calculate_points_from_objectives(plates_top, plates_other, turrets_top,
    ...
    Args:
        ...
        turrets_top: Turrets destroyed in top lane
    ...
    for i, t in enumerate(time_points):
        ...
        if completion_time > 0:
            ...
            obj_points = calculate_points_from_objectives(
                ...
                turrets_top * progress, turrets_other * progress,
...
class TopLaneQuestCalculatorGUI:
    ...
    def get_inputs(self):
        ...
        try:
            ...
            plates_top = int(self.plates_top.get())
            plates_other = int(self.plates_other.get())
            turrets_top = int(self.turrets_top.get())
...
def main():
    root = tk.Tk()
    app = TopLaneQuestCalculatorGUI(root)
    root.mainloop()
